<div class="container mt-5 overflow-auto" style="max-height: 600px">
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-md-6">
                    <h3>Chi tiết hóa đơn - ID: <?php echo $data['chi_tiet_hoa_don']['hoa_don']['ma_hoa_don']; ?></h3>
                </div>
                <div class="col-md-6">
                    <?php
                    $order_status = $data['chi_tiet_hoa_don']['hoa_don']['trangthai']; // Thay đổi theo cấu trúc dữ liệu của bạn
